...
//        printNumberOfAnimals(animalArrayList);
        ...
        System.out.println("Position of Sher Khan in the arraylist is: " + animalArrayList.indexOf(sherKhan));
    ...
    private static void printNumberOfAnimals(ArrayList<Animal> animalArrayList) {
        System.out.println("Numbers of animals in circus(AL): " + animalArrayList.size());
    }
